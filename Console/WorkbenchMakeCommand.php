...
namespace Fromz\Workbench\Console;

use Illuminate\Console\Command;
use Fromz\Workbench\Package;
use Fromz\Workbench\PackageCreator;
...
class WorkbenchMakeCommand extends Command
{
     ...
     *
     * @param \Fromz\Workbench\PackageCreator $creator
     */
     ...
     *
     * @param \Fromz\Workbench\Package $package
     *
     * @return string
     */
